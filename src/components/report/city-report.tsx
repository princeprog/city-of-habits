...
export function CityReport() {
  ...
  if (!habits.length) {
    return <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center p-5 sm:p-8"><Empty className="max-w-lg"><EmptyHeader><EmptyMedia variant="icon"><CalendarDays /></EmptyMedia><EmptyTitle><h1>Your first report is waiting.</h1></EmptyTitle><EmptyDescription>Create a habit and the city will begin keeping a private record of its rhythm.</EmptyDescription></EmptyHeader></Empty></div>
  }
